...
<body>
  <div class="container">
    ...
    <h2 class="nav navbar-nav">dojo_Mojo</h2>
    ...
    <a href="/carts" class="nav navbar-nav navbar-right"><button type="button" class="shopping_cart btn-lg" aria-label="Shopping Cart">
